...
public class GameManager : MonoBehaviour
{
    ...
    public float guideVideoLeadTime = 3.0f; // ���� ������ �� �� ���� ��������
    ...
    void SpawnNote(NoteData data)
    {
        ...
        {
            Debug.LogError($"[GameManager] laneSpawnTops[{lane}] �� �������� ����");
            return;
        }

        if (laneHitLines == null || laneHitLines.Length <= lane || laneHitLines[lane] == null)
        {
            Debug.LogError($"[GameManager] laneHitLines[{lane}] �� �������� ����");
            return;
        }
        ...
        if (controller == null)
        {
            Debug.LogError("[GameManager] NotePrefab�� NoteController ����");
            return;
        }
